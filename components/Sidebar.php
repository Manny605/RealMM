...
<ul class="navbar-nav bg-light sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Commandes -->
    <li class="nav-item <?php if(strpos($_SERVER['PHP_SELF'], 'pages/commandes/') !== false && basename($_SERVER['PHP_SELF']) == 'commandes.php') echo 'active'; ?>">
    ...
    <!-- Nav Item - Commandes validées -->
    <li class="nav-item <?php if(strpos($_SERVER['PHP_SELF'], 'pages/commandes/') !== false && basename($_SERVER['PHP_SELF']) == 'commandes_validees.php') echo 'active'; ?>">
        <a class="nav-link" href="/MixMart/admin/pages/commandes/commandes_validees.php">
