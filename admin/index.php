                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Gains (Mensuel)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">40,000 MRU</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Gains (Annuel)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">215,000 MRU</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Bilan financier</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
